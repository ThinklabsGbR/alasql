...
## Please note
AlaSQL project is very young and still in active development phase, therefore it <s>may have</s> has bugs. Please, wait a little bit before using it in production.  Please, submit any bugs and suggestions [as an issue](https://github.com/agershun/alasql/issues/new).
